...
Qle, Qh and NEE for each FLUXNET site. I created zoomboxes over Europe, 
US and Australia. Data generatred by method 2 script.
...
print(df_results_LH.overall.mean())
print(df_results_SH.overall.mean())
print(df_results_NEE.overall.mean())
...
p2 = zoommap(df_results_LH.smallerthan2stdev, 
             "Lowest 2.3 % temperatures", "(b)")
p3 = zoommap(df_results_LH.largerthan2stdev,
             "Highest 2.3 % temperatures","(c)")
...
p1[0].savefig(os.path.join(plot_dir, "Qle_overall.pdf"),
            bbox_inches='tight', pad_inches=0.1)
p2[0].savefig(os.path.join(plot_dir, "Qle_lower.pdf"),
            bbox_inches='tight', pad_inches=0.1)
p3[0].savefig(os.path.join(plot_dir, "Qle_upper.pdf"),
            bbox_inches='tight', pad_inches=0.1)
p4[0].savefig(os.path.join(plot_dir, "Qh_overall.pdf"),
            bbox_inches='tight', pad_inches=0.1)
p5[0].savefig(os.path.join(plot_dir, "Qh_lower.pdf"),
            bbox_inches='tight', pad_inches=0.1)
p6[0].savefig(os.path.join(plot_dir, "Qh_upper.pdf"),
            bbox_inches='tight', pad_inches=0.1)
p7[0].savefig(os.path.join(plot_dir, "NEE_overall.pdf"),
            bbox_inches='tight', pad_inches=0.1)
p8[0].savefig(os.path.join(plot_dir, "NEE_lower.pdf"),
            bbox_inches='tight', pad_inches=0.1)
p9[0].savefig(os.path.join(plot_dir, "NEE_upper.pdf"),
            bbox_inches='tight', pad_inches=0.1)
