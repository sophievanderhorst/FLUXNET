...
"""
I use this script to plot the ratios relative to Temperature and precipitation. 
I do this for Qle, Qh and NEE for all temperatures, the lower extreme and the 
upper extreme.  Data generated by method2 script.
...
fig, ax = plt.subplots(nrows=3, ncols=3, figsize =(10,15), sharex = True, sharey =True)
...
prectemp(df_results_LH.meantemp-273, df_results_LH.meanprec, 
         df_results_LH.overall, "Qle ratio all temperatures ",  ax[0,0], "(a)")
prectemp(df_results_SH.meantemp-273, df_results_SH.meanprec, df_results_SH.overall, 
         "Qh ratio all temperatures ",  ax[1,0], "(b) ")
prectemp(df_results_NEE.meantemp-273, df_results_NEE.meanprec, 
         df_results_NEE.overall,"NEE ratio all temperatures ",  ax[2,0], "(c)")
...
ax[2,0].set_xlabel("Temperature ($\degree$C)", fontsize = 12)
ax[2,1].set_xlabel("Temperature ($\degree$C)", fontsize = 12)
ax[2,2].set_xlabel("Temperature ($\degree$C)", fontsize = 12)
