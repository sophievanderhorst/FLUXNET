...
without zoom. Also, the results are shown in tables. 
"""
    # Import packages
...
plt.title("Suitable sites all temperatures", fontsize = 14)   
plt.text(0.03, 1.18, "(a)", size = 12,  horizontalalignment='center', 
...
fig =  plt.figure(figsize=(11,8))
plt.title("Suitable sites lower extreme", fontsize = 14)  
plt.text(0.03, 1.18, "(b)", size = 12,  horizontalalignment='center', 
     verticalalignment='center', transform=ax.transAxes)
m = Basemap(projection = 'mill', llcrnrlat = -45, llcrnrlon = -160, 
            urcrnrlat= 82, urcrnrlon = 170, resolution = 'c')
m.drawcoastlines(linewidth = 0.5)
...
fig =  plt.figure(figsize=(11,8))
plt.title("Suitable sites upper extreme", fontsize = 14) 
plt.text(0.03, 1.18, "(c)", size = 12,  horizontalalignment='center', 
     verticalalignment='center', transform=ax.transAxes)  
m = Basemap(projection = 'mill', llcrnrlat = -45, llcrnrlon = -160, 
            urcrnrlat= 82, urcrnrlon = 170, resolution = 'c')
m.drawcoastlines(linewidth = 0.5)
